        ...
        <div class="container md:w-[140%] md:ml-[-20%] px-0 md:pt-0">
            <div class="flex py-0 dark:text-white relative justify-end items-center mx-auto">
                ...
                <div class="w-[55%] hidden md:flex flex-col items-center justify-start shadow-lg
                    ...
                    <p class="w-full text-6xl py-4 m-0">Han Xue</p>
                    ...
                    <p class="mt-4 w-full pl-3 m-0">
                        <span class="m-0">
                            <a href="mailto:xiaoxiaoxh@sjtu.edu.cn">
                            ...
                            <a href="https://github.com/xiaoxiaoxh">
                                <img class="inline dark:invert w-6 mr-3 opacity-75 hover:opacity-100 transition-opacity m-0"
                                    src="/assets/img/icons/github.svg" alt="">
                            </a>
                            <a href="https://scholar.google.com.hk/citations?user=kQMFnUkAAAAJ">
                                <img class="inline dark:invert w-6 mr-3 opacity-75 hover:opacity-100 transition-opacity m-0"
                                    src="/assets/img/icons/google-scholar.svg" alt="">
                            </a>
                            <a href="https://twitter.com/HanXue012">
                                <img class="inline dark:invert w-6 mr-3 opacity-75 hover:opacity-100 transition-opacity m-0"
                ...
                <img class="w-full md:w-1/2 shadow-lg my-0 md:my-12 z-10" src="/assets/img/hanxue.jpg" alt="" />

                <div class="absolute h-full w-[75%] left-0 z-[-1]"></div>

                <img class="hidden md:block absolute w-2/5 top-[-2.5rem] left-[2rem] dark:invert z-[-1] opacity-30"
                    src="/assets/img/Universe.svg" alt="">
            </div>
        ...
        <div class="hidden md:block w-full h-fit p-0 m-0 absolute mx-auto top-0 left-0 z-[-2] bg-neutral-200 dark:bg-neutral-800">
            <div class="max-w-prose mt-[3.4rem] opacity-0">
                <div class="container w-[140%] ml-[-20%] px-0 md:pt-0">
                    <div class="flex py-0 dark:text-white relative justify-end items-center mx-auto">
                        <img class="w-full md:w-1/2 shadow-lg my-12 z-10" src="/assets/img/hanxue.jpg" alt="" />
                    </div>
                </div>
            </div>
        </div>
